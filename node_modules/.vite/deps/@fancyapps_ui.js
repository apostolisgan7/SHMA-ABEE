...
var E = (c5, b3 = {}, E3 = {}) => {
  ...
  const je = { canDrag: be, canZoomIn: pe, canZoomOut: me, canZoomToFull: ve, destroy: function() {
    ...
    return je;
  }, toggleFS: Me, updateControls: ce, version: "6.1.7", willZoomIn: ge, willZoomOut: he };
  return je;
};
...
var c3 = () => {
  ...
  function T(t9) {
    const e11 = t9.thumb ? t9.thumb instanceof HTMLImageElement ? t9.thumb.src : t9.thumb : t9.thumbSrc || void 0, o9 = void 0 === t9.thumbAlt ? `Thumbnail #${(t9.index || 0) + 1}` : t9.thumbAlt + "";
    let i9 = b3("thumbTpl");
    return i9 = n5(i9, "{{alt}}", o9), i9 = n5(i9, "{{src}}", e11 + ""), i9 = n5(i9, "{{index}}", `${t9.index || 0}`), i9 = n5(i9, "{{page}}", `${(t9.index || 0) + 1}`), i9;
  }
  function L(t9) {
...
var l5 = () => {
  ...
  function d3(t9, o9) {
    ...
    if (!l9 || "youtube" === l9) {
      ...
      if (t10) {
        const e11 = Object.assign(Object.assign({}, r7().youtube), o9.youtube || {}), s12 = `www.youtube${e11.nocookie ? "-nocookie" : ""}.com`, a9 = n8(i9, e11), c6 = encodeURIComponent(t10[2]);
    ...
    if (!l9 || "vimeo" === l9) {
      ...
      if (t10) {
        const e11 = Object.assign(Object.assign({}, r7().vimeo), o9.vimeo || {}), s12 = n8(i9, e11), a9 = encodeURIComponent(t10[2]), c6 = t10[5] || "";
  ...
  function m3(t9, n11) {
    "html5video" === n11.type && (function(t10) {
      ...
      m4.classList.add("f-html"), m4.append(d4), t10.contentEl = d4, t10.htmlEl = m4, n12.classList.add(`has-${t10.type}`), n12.prepend(m4), h3(t10), l8.emit("contentReady", t10);
      ...
      for (const [t11, o10] of Object.entries(r7().iframeAttr || {})) e11.setAttribute(t11, o10);
      e11.onload = () => {
        var o10;
  ...
  function p2() {
    ...
    (t9 && void 0 !== t9.autoplay ? t9.autoplay : r7().autoplay) && ((function() {
      var t10;
      const e11 = a8(), o9 = null == e11 ? void 0 : e11.el;
      ...
      const t10 = a8(), e11 = null == t10 ? void 0 : t10.type;
  ...
  function h3(t9) {
    ...
    if (t9 && e11 && ("html5video" === t9.type || "youtube" === t9.type || "vimeo" === t9.type)) {
      ...
      if (t9.aspectRatio) {
        ...
        e11.offsetHeight;
        const s12 = e11.getBoundingClientRect(), r8 = l9 < (s12.width || 1) / (s12.height || 1);
        e11.style.aspectRatio = `${t9.aspectRatio}`, e11.style.width = r8 ? "auto" : "", e11.style.height = r8 ? "" : "auto";
      }
    }
  }
  function v3() {
...
var N = { Plugins: { Hash: f2 }, version: "6.1.7", openers: /* @__PURE__ */ new Map(), bind: function(e11, n11, o9, i9) {
  if (!e8()) return;
