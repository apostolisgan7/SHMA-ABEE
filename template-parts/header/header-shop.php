        ...
        <div class="header-inner">
            ...
            <div class="header-right">
                ...
                <div class="header-search head_item">
                    <button type="button" class=" flex items-center gap-2 search-toggle header-link" aria-label="<?php esc_attr_e( 'Open search', 'ruined' ); ?>">
                    ...
                    <button type="button" class="search-toggle search_mobile" aria-label="<?php esc_attr_e( 'Open search', 'ruined' ); ?>">
