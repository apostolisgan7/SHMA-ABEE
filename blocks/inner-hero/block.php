...
<div class="inner-hero section-full-width <?= esc_attr($block['className'] ?? ''); ?> <?= !empty($block['align']) ? 'align' . $block['align'] : ''; ?>"
     style="<?= !$video_url ? esc_attr($style) : ''; ?>">

    <?php if ($video_url && $video_type): ?>
        <div class="inner-hero__video-wrapper">
            <?= $video_embed; ?>
        </div>
    <?php endif; ?>
    ...
    <div class="inner-hero__inner container">
