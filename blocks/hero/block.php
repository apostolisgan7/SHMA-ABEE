...
<div class="home-hero section-full-width <?= esc_attr($block['className'] ?? ''); ?> <?= !empty($block['align']) ? 'align' . $block['align'] : ''; ?>"
    ...
    <div class="home-hero__inner container">
        <div class="home-hero__content">
            ...
            <?php if (!empty($title)): ?>
                <div class="home-hero__title"><?= wp_kses_post($title); ?></div>
            <?php endif; ?>

            <div class="bottom_content">
                <?php if (!empty($sub_texts['sub_title'])): ?>
                    <div class="home-hero__subtitle"><?= esc_html($sub_texts['sub_title']); ?></div>
                <?php endif; ?>

                <?php if (!empty($sub_texts['subtext'])): ?>
                    <p class="home-hero__text"><?= esc_html($sub_texts['subtext']); ?></p>
                <?php endif; ?>
